    ...
    return (
        <>
            ...
            <Transition
                ...
                show={modalOpen}
                enter="transition ease-out duration duration-200"
                ...
                <div ref={modalContent} className="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg">
                    ...
                    <form className="border-b border-slate-200">
                        <div className="relative">
                            ...
                            <input type="text" placeholder="Search Anything..." ref={searchInput} id={searchId} className="w-full border-0 focus:ring-transparent placeholder-slate-400 appearance-non py-3 pl-10 pr-4" />
                    ...
                    <div className="py-4 px-2">
                        ...
                        <div className="mb-3 last:mb-0">
                            <div className="text-xs font-semibold text-slate-400 uppercase px-2 mb-2">Recent Search</div>
